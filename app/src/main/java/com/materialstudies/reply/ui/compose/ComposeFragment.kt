...
class ComposeFragment : Fragment() {
    ...
    private fun expandChip(chip: View) {
        ...
        val transform = MaterialContainerTransform().apply {
            ...
            scrimColor = Color.TRANSPARENT
            endElevation = requireContext().resources.getDimension(R.dimen.email_recipient_card_popup_elevation_compat)
    ...
    private fun collapseChip(chip: View) {
        ...
        val transform = MaterialContainerTransform().apply {
            ...
            endView = chip
            scrimColor = Color.TRANSPARENT
            startElevation = requireContext().resources.getDimension(R.dimen.email_recipient_card_popup_elevation_compat)
            addTarget(chip)
        }
        TransitionManager.beginDelayedTransition(binding.composeConstraintLayout, transform)
